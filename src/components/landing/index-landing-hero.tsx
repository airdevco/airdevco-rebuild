    ...
    <section className="relative pt-32 pb-12 lg:pt-48 lg:pb-16 overflow-x-hidden bg-white scroll-mt-[88px]">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-[56px] lg:text-[80px] leading-[1.05] font-semibold tracking-[-0.03em] text-gray-900 mb-8 mx-auto">
            A better way to launch your product
          </h1>

          <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
            We use the latest in AI and visual development to build world-class software in a fraction of time and
            cost of conventional agencies.
          </p>
        </div>
      </div>

      {/* Same order as /saas hero: copy then screenshot grid (keeps tiles above the fold on most laptops) */}
      <div className="relative z-10 mt-8 w-full max-w-[min(1920px,calc(100vw-1.25rem))] 2xl:max-w-[min(2000px,calc(100vw-2rem))] mx-auto px-3 sm:px-5 lg:px-8">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 mt-10 lg:mt-12">
