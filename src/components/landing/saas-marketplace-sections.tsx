...
function CellContent({
  ...
  const textCls = isAirdev
    ...
    : "font-normal text-[#64748B] text-[16px] leading-[24px]";
...
export function MarketplacePricingSection() {
  return (
    <section id="pricing" className="scroll-mt-[88px] py-20 md:py-28 bg-white">
      <div className="max-w-[1200px] mx-auto px-6">
        <p className="text-[#1e3a8a] font-semibold tracking-wide uppercase text-sm mb-3 text-center">Pricing</p>
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-[#0A2540] tracking-tight mb-4 text-center">
          Choose your path
        </h2>
        <p className="text-lg text-[#425466] text-center max-w-2xl mx-auto mb-14">
          Start lean or go all-in. Scale up anytime.
        </p>

        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="rounded-2xl border border-slate-200 bg-slate-50/50 p-8 md:p-10 flex flex-col shadow-sm">
            <h3 className="text-2xl font-semibold text-[#0A2540] mb-2">Launchpad</h3>
            <p className="text-3xl font-semibold text-[#1265EF] mb-2">$5k+</p>
            <p className="text-slate-600 mb-8">Start from a template and make it your own</p>
            <ul className="space-y-4 flex-1 mb-8">
              {LAUNCHPAD_BULLETS.map((b) => (
                <li key={b} className="flex gap-3 text-[#1a1a1a]">
                  <span className="text-[#1265EF] shrink-0">✓</span>
                  <span>{b}</span>
                </li>
              ))}
            </ul>
            <button
              ...
              className="w-full rounded-[6px] border-2 border-[#1265EF] text-[#1265EF] font-medium py-3 hover:bg-[#1265EF] hover:text-white transition-colors"
            >
              Get started
            </button>
          </div>

          <div className="rounded-2xl border-2 border-[#1265EF] bg-white p-8 md:p-10 flex flex-col shadow-md">
            <h3 className="text-2xl font-semibold text-[#0A2540] mb-2">Agency</h3>
            <p className="text-3xl font-semibold text-[#1265EF] mb-2">$20k+</p>
            <p className="text-slate-600 mb-8">Build anything that fits your needs</p>
            <ul className="space-y-4 flex-1 mb-8">
            ...
            <button
              type="button"
              onClick={scrollToContact}
              className="w-full rounded-[6px] bg-[#1265EF] text-white font-medium py-3 hover:bg-[#0E4FCC] transition-colors"
            >
              Get started
            </button>
          </div>
