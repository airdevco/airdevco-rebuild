...
interface KnowledgeManagementCTAProps {
  title?: string;
  description?: string;
  buttonText?: string;
  buttonLink?: string;
    ...
    <section className={`relative isolate overflow-hidden ${isLight ? "bg-[#f6f9fc]" : "bg-[#0A2540]"} py-20`}>
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h2
            className={`text-4xl lg:text-5xl font-semibold tracking-tight ${isLight ? "text-gray-900" : "text-white"}`}
