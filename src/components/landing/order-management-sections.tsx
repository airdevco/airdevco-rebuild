    ...
    <section className="relative pt-32 pb-12 lg:pt-48 lg:pb-16 overflow-hidden bg-white scroll-mt-[88px]">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mt-8">
            <Button type="button" className={ORDER_MANAGEMENT_PRIMARY_BTN} onClick={openLandingPricingPopup}>
              Get started
            </Button>
          </div>
        </div>
...
const ORDER_MANAGEMENT_CASE_SLIDES_RAW = [
  {
    id: "greener",
...
export const ORDER_MANAGEMENT_CASE_SLIDES = ORDER_MANAGEMENT_CASE_SLIDES_RAW.map((slide) => ({
  ...slide,
